...
async function get(path, params = {}) {
	...
	Object.entries({ language: "pt-BR", ...params }).forEach(([key, value]) => {
...
export const image = (path, backdrop = false) =>
	path ? `${backdrop ? BACKDROP_URL : IMAGE_URL}${path}` : null;
...
export const tmdb = {
	...
	providers: (type, id) =>
		get(`/${type}/${id}/watch/providers`, { language: null }),
